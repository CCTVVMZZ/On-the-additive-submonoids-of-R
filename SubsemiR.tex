...
\begin{proof}
  ...
  (Equality $(n + 1) I = n I + I$ holds true for every $n \in \bN$ because $I$ is an interval, whence 
  $$
  S = \bigcup_{n = 0}^\infty n I 
  $$
  ). 
  Since the cardinality of $I$ greater than $3$,
  ...
  By construction,
  % $J$ is an interval,
  % $1$ is an element of $J$,
  % $1$ is not the least element of $J$, and
  % $1$ is not the greatest element of $J$.
  % Therefore,
  $J$ is a neighborhood of $1$ in~$\bR$.
  In particular, there exists $\epsilon \in \Rpos$ such that $\left[1, 1 + \epsilon \right[ \subseteq J$.
  Put $m = \ceil{\epsilon^{-1}}$: $m \epsilon \ge 1$.
  For each integer $n \ge m$,
  we have $n \epsilon \ge 1$, whence 
  $$
  \left[n, n + 1 \right[
  \subseteq
  \left[n, n + n \epsilon \right[
  =
  n \left[1, 1 + \epsilon \right[
  \subseteq
  n J \, . 
  $$
  It follows
 ...
 %It can be shown with a little more work that 
