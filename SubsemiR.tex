...
\begin{proof}
  ...
  % (The additive closure of $\left[1, 1 + \epsilon \right[$ is equal to
  % $$
  % \left[m, \infty \right[ \cup  \bigcup_{n = 1}^{m - 1} \left[ n, n + n \epsilon \right[ 
  % $$
  % and has exactly $m$ connected components; the verification is left to the reader).
 \end{proof}
